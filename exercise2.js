...
// Using the dot notation, assign a color property to the favCar object and give it a string value with
// the color of your choice.
// Using the dot notation, assign a covertible property to the favCar object and give it a
//  boolean value of your choice.
// Use the console to log the entire favCar object.

var clothes = [];
clothes.push("T-shirt", "Jeans", "Sweater", "Jacket", "Dress");
console.log(clothes);
clothes.pop();
clothes.push("Skirt");
