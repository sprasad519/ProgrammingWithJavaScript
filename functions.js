// Your task in this exercise is to code a function which will be able to take a word and locate the position of
...
function findLetterIndices(word, match) {
  const indices = []; // Store found indices
